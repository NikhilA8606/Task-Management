...
from tasks.views import add_task_view,delete_task_view,GenericTaskView,GenericTaskCreateView,UserCreateView,UserLoginView, GenericTaskUpdateView,GenericTaskDetailView,GenericTaskDeleteView,session_storage_view,CompleteTaskView
...
urlpatterns = [
    ...
    path('complete-task/<pk>/', CompleteTaskView.as_view()),
